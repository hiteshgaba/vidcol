...
if($_POST['search'])
{
	...
	if($numrows !=0)
	{
		...
		{echo '<a rel="external" href="video.php?category='.$category[$i].'&name='.$vname.'" style="text-decoration:none;" ><div class="video1">
    ...
    font-family:"Lucida Grande","bitstream vera sans","trebuchet ms",verdana,arial;"><b >'.$vname.'</b><br><span style="
 color:#333; font-size:10px; padding-top:5px; padding-left:2px; padding-right:4px;height:100px;overflow:none;
