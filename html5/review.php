<?php
echo ('<script>alert("cvcvc");</script>');
error_reporting(0);
session_start();
...
{	if($choice=='like')
 ...
 if($vallike==1) echo '<td> <span style="float:left;color:#777;font-family:Arial, Helvetica, sans-serif; font-size:13px; "><a href="signin.php" style="text-decoration:none">SignIn</a> or <a href="register.php" style="text-decoration:none">SignUp</a></span></td>';
 if($urrev==1)
...
?>
	...
	<div class="num"><div class="numlike" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;" >

<?php echo $lk;?> likes,</div><div class="numdislike" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;">&nbsp;<?php echo $dk;?> dislikes</div></div></div>
