...
--
-- Host: localhost
-- Generation Time: Jul 29, 2012 at 03:31 PM
...
(1, 'Fedora 15 Review', 'linux/Fedora 15 Review.mp4', 'An in-depth look at Fedora 15 Lovelock, sporting the new stable GNOME 3 desktop and GNOME Shell. Fedora is a well supported distribution, and the fusion of GNOME Shell and Fedora''s base creates an innovative, modern and polished desktop for the Linux enthusiast and power user. Definitely a great peek into the future of desktop Linux and it''s a substantially widget base than GNOME and GTK 2.x. Very polished, and arguably much better (think finished) than Unity.', 'fedora', 'linux/Fedora 15 Review.jpg', 0, 1),
(2, 'KDE 46 Stability Test (archlinux)', 'linux/KDE 46 Stability Test (archlinux).mp4', 'Well Well Well.... After giving Kde 4.5xx series a poor review due to instability issues.... I can now Finally say that KDE IS READY! This Desktop Environment is Amazing! Very minor quirks but overall.... Very Stable and Sooooo Feature rich. And Theres still alot more features to come and improve with the next few releases!', 'KDE 46', 'linux/KDE 46 Stability Test (archlinux).jpg', 1, 3),
(3, 'Ubuntu 1004 Compiz hard test FULL HD', 'linux/Ubuntu 1004 Compiz hard test FULL HD.mp4', 'Ubuntu 10.04 LTS Lucyd 64 bit MAINSONG: Globus Epicon Europa, Immediate Music - Age of Discovery LOWER BAR- Cairo-Dock with openGl ver. DOME PICTURE: my Creation', 'Ubuntu', 'linux/Ubuntu 1004 Compiz hard test FULL HD.jpg', 2, 4),
(4, 'LinuxMint', 'linux/LinuxMint.mp4', 'Linux Mint 9 Release Candidate was released today. This is the first public release , and so far it doesn''t disappoint. A better and easier to use version of Ubuntu, with it''s own unique features.', 'Linux Mint', 'linux/LinuxMint.jpg', 0, 1),
(5, 'OpenSUSE 113 KDE 64bit Linux', 'linux/OpenSUSE 113 KDE 64bit Linux.mp4', 'Screencast Review & how-to Install Tutorial of the OpenSUSE 11.3 64bit Linux OS with KDE 4.4.4 which I demonstrate inside a Virtual Machine with Ubuntu 10.10 as the Host Operating System. "The openSUSE project is pleased to announce the release of the latest incarnation of openSUSE, with support for 32-bit and 64-bit systems.', 'OpenSUSE', 'linux/OpenSUSE 113 KDE 64bit Linux.jpg', 0, 1),
(6, 'Pinguy OS 1104', 'linux/Pinguy OS 1104.mp4', 'An in-depth look at Fedora 15 Lovelock, sporting the new stable GNOME 3 desktop and GNOME Shell. Fedora is a well supported distribution, and the fusion of GNOME Shell and Fedora''s base creates an innovative, modern and polished desktop for the Linux enthusiast and power user. Definitely a great peek into the future of desktop Linux and it''s a substantially widget base than GNOME and GTK 2.x. Very polished, and arguably much better (think finished) than Unity.', 'Pinguy OS', 'linux/Pinguy OS 1104.jpg', 0, 1),
(7, 'Red Hat CEO on RHEL 6', 'linux/Red Hat CEO on RHEL 6.mp4', 'Jim Whitehurst, Red Hat CEO and chairman of the board, gives an overview of the advantages of Red Hat Enterprise Linux 6, and explains why this award-winning version brings even more to the technology table. Red Hat Enterprise Linux 6 is more reliable than Windows, more open than Oracle, and more comprehensive than VMware. It is the industry standard, used by everyone from the DoD to Wall Street, and everywhere from standard desktops to the cloud.', 'Red Hat', 'linux/Red Hat CEO on RHEL 6.jpg', 0, 5),
(8, 'KOffice Teaser', 'linux/KOffice Teaser.mp4', 'I included a small preview of other productivity apps like the KDE PIM suite (kontact) , Scribus and Inkscape', 'KOffice', 'linux/KOffice Teaser.jpg', 0, 1);
...
(8, 'Kobe Bryant Amazing Buzzer Beater', 'sports/Kobe Bryant Amazing Buzzer Beater.flv', 'amazing best basket-baller Kobe brayant', 'kobe best', 'sports/Kobe Bryant Amazing Buzzer Beater.jpg', 0, 0);
...
(7, 'Google Summit', 'technology/summit.mp4', 'Google Summit', 'google', 'technology/summit.jpg', 0, 0);
