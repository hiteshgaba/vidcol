...
<!-- Login Form start -->
<form id="searchForm" action="login.php" method="post" style="padding:5px 0">
<div>
User Name<br>
<input name="username" type="text" size="15" maxlength="128" style="color:#333;font-family:sans-serif;width:65%;padding:0" value=""><br>
Password<br><input name="password" type="password" size="15" maxlength="128" style="color:#333;font-family:sans-serif;width:65%;padding:0" value=""><br><br>
<a href="signup.php"><u>
Sign up for a new account on Vidcol</u></a><br>
<input type="submit" name="submit" value="Login" style="font-size:100%;padding:0;margin-top:2px;color:black"><br>
</div>
</form>
